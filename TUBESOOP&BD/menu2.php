...
$result = mysqli_query($koneksi, "SELECT
    ...
    e.JENIS_BARANG,
    e.NAMA_MERK,
    h.NAMA_MERK AS HARGA_NAMA_MERK,
    h.`HARGA_PER-UNIT`,
    s.NAMA_MERK AS STOK_NAMA_MERK,
    s.STOK_BARANG
FROM
    tabel_elektronik e
INNER JOIN tabel_harga h ON h.ID_ELEKTRONIK = e.ID_ELEKTRONIK
INNER JOIN tabel_stok s ON s.ID_ELEKTRONIK = e.ID_ELEKTRONIK
ORDER BY
    e.ID_ELEKTRONIK");
  ...
  <div class="container-fluid">
        ...
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="index.php">Menu1</a></li>
              <li><a class="dropdown-item" href="daftar elektronik.php">Menu2</a></li>
              <li><a class="dropdown-item" href="manu2.php">Menu3</a></li>
              <li>
    ...
    <div class="col-8">
        <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
            <div class="container mx-auto"> <!-- Added mx-auto to center the container horizontally -->
