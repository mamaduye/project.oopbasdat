...
<nav class="navbar bg-body-tertiary text-muted ">
  <div class="container-fluid">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="daftar elektronik.php">Menu3</a></li>
              <li>
     ...
     <div class="container">
            <h1><strong>Selamat Datang di ELEKTRONIKU</h1>
            <p>
                
            </p>
           <div> <img src="Desain tanpa judul.png" class="photo">
           </div>
           <div class="profile-description">
            ...
            <p></p>
            <p></p>
            <p><strong>NIM :</strong> 202211018</p>
            <p><strong>Prodi :</strong> Teknik Informatika</p>
            <p><strong>Hobby :</strong> Membesarkan Ayam</p>
      </div>



      <div> <img src="Desain tanpa judul-1.png" class="photo">
           </div><div class="profile-description">
            <h2><strong>MAMAD</h2>
            <p></p>
            <p></p>
            <p></p>
            <p><strong>NIM :</strong> 202211004</p>
            <p><strong>Prodi :</strong> Teknik Informatika</p>
            <p><strong>Hobby :</strong> Menonton Debat</p>
        </div>
           <!-- ... (tambahkan konten lainnya sesuai kebutuhan) ... -->
     </div>
             
                 <!--...tampilkan info elektronik-->
                 <div class="container">
                    <?php
        ...
        <ul class="pagination justify-content-center">
          ...
          <li class="page-item"><a class="page-link" href="daftar elektronik.php">3</a></li>
          <li class="page-item">
